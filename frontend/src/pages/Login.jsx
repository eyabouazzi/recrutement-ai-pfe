...
function getDefaultRedirectPath(role) {
  if (role === 'HR') return '/rh/dashboard';
      ...
      <div style={body}>
        ...
        <div style={rightPanel}>
          <motion.div style={card}
            ...
            {/* Google SSO */}
            <button style={googleBtn} type="button" onClick={() => message.info('Google bientôt disponible')}>
              <IcoGoogle /> Continuer avec Google
            </button>

            <div style={divRow}>
              <div style={divLine} /><span style={divTxt}>ou e-mail</span><div style={divLine} />
            </div>
            ...
            <form onSubmit={handleSubmit} noValidate>
              ...
              <label style={rememberRow}>
                ...
                <span style={{ fontSize: 14, color: '#64748b' }}>Se souvenir de moi</span>
              </label>
...
const divRow = { display: 'flex', alignItems: 'center', gap: 12, margin: '20px 0' };
const divLine = { flex: 1, height: 1, background: '#f1f5f9' };
const divTxt = { fontSize: 11.5, color: '#cbd5e1', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.08em', whiteSpace: 'nowrap' };
...
const rememberRow = {
  display: 'flex', alignItems: 'center', gap: 8, marginBottom: 22, cursor: 'pointer',
};
const submitBtn = {
